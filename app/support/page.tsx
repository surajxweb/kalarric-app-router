          ...
          <div className={styles.sections}>
            <div className={styles.section}>
              ...
              <p>
                ...
                Simply click on the Question Mark below or the Help Button on
                the bottom right corner of your desktop screen to get started.
              </p>
              <BiSolidHelpCircle
            ...
            <div className={styles.section}>
              ...
              <p>
                ...
                chat, our WhatsApp support is designed to make assistance
            ...
            <div className={styles.section}>
              ...
              <p>
                For a more personalized touch, you can always email us directly
                at{" "}
                <Link
                  target='_blank'
                ...
                >
                  <span style={{ color: "red" }}>
                    support@kalarric.freshdesk.com
                  </span>
                </Link>
                . Our support executives are standing by to respond to your
                emails and address your concerns, ensuring you get the help you
                need.
              </p>
            ...
            <div className={styles.section}>
              ...
              <p>
                ...
                experience. Easily raise tickets, track their status, and engage
                in a comprehensive conversation with our support team, all in
                one place.
              </p>
              <p>
                Just visit{" "}
